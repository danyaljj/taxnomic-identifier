...
// F1B88000000000000000B2A4D4CC158267EA07EA4D0FCCB2E294CCB4E4558CCCB26D450B1D558A6582A4D292D2AC30908E51727E715AA37E717CB3726900195B24D20069319C14B3000000
...
public class sCxCy extends Classifier
{
  public sCxCy()
  {
  ...
  public double realValue(Object __example)
  {
    if (!(__example instanceof Instance))
    {
      ...
      System.err.println("Classifier 'sCxCy(Instance)' defined on line 23 of RelationClassifier.lbj received '" + type + "' as input.");
  ...
  public int hashCode() { return "sCxCy".hashCode(); }
  public boolean equals(Object o) { return o instanceof sCxCy; }
}
