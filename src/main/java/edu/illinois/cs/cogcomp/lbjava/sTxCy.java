...
// F1B88000000000000000B2A4D4CC1582E09A07EA4D0FCCB2E294CCB4E4558CCCB26D450B1D558A6582A4D292D2AC30908E51727E715AA37E717CB36251B3726985B24D2000FE802270B3000000
...
public class sTxCy extends Classifier
{
  public sTxCy()
  {
  ...
  public double realValue(Object __example)
  {
    if (!(__example instanceof Instance))
    {
      ...
      System.err.println("Classifier 'sTxCy(Instance)' defined on line 24 of RelationClassifier.lbj received '" + type + "' as input.");
  ...
  public int hashCode() { return "sTxCy".hashCode(); }
  public boolean equals(Object o) { return o instanceof sTxCy; }
}
