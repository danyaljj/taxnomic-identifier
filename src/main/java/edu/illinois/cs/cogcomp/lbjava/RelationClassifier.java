...
public class RelationClassifier extends SparseNetworkLearner
{
  private static void loadInstance()
  {
    if (instance == null) instance = new RelationClassifier(true);
  }
  ...
  public static RelationClassifier instance;

  public static RelationClassifier getInstance()
  {
    loadInstance();
    return instance;
  }

  private RelationClassifier(boolean b)
  {
    super(new SparseAveragedPerceptron(Constants.learningRate, Constants.learningThreshold, Constants.learningThickness));
    containingPackage = "edu.illinois.cs.cogcomp.lbjava";
    name = "RelationClassifier";
    setEncoding(null);
    setLabeler(new Label());
    setExtractor(new RelationClassifier$$1());
    isClone = false;
  }
  ...
  public RelationClassifier()
  {
    super("edu.illinois.cs.cogcomp.lbjava.RelationClassifier");
    isClone = true;
  }

  public RelationClassifier(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

  public RelationClassifier(Parameters p, String modelPath, String lexiconPath) {
    super(p);
    try {
    ...
    else if (IOUtilities.existsInClasspath(RelationClassifier.class, modelPath)) {
      System.out.println("Model file "+modelfile.getAbsolutePath()+" located in a jar file");
      readModel(IOUtilities.loadFromClasspath(RelationClassifier.class, modelPath));
      readLexiconOnDemand(IOUtilities.loadFromClasspath(RelationClassifier.class, lexiconPath));
    }
    else {
      containingPackage = "edu.illinois.cs.cogcomp.lbjava";
      name = "RelationClassifier";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof Instance || example instanceof Object[]))
      {
        String type = example == null ? "null" : example.getClass().getName();
        System.err.println("Classifier 'RelationClassifier(Instance)' defined on line 33 of RelationClassifier.lbj received '" + type + "' as input.");
  ...
  public void learn(Object[] examples)
  {
    if (isClone)
    {
      if (!(examples instanceof Instance[] || examples instanceof Object[][]))
      {
  ...
  public Feature featureValue(Object __example)
  {
    if (isClone)
    {
      if (!(__example instanceof Instance || __example instanceof Object[]))
      {
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: edu.illinois.cs.cogcomp.lbjava.RelationClassifier \\");
  ...
  public int hashCode() { return "RelationClassifier".hashCode(); }
  public boolean equals(Object o) { return o instanceof RelationClassifier; }

  public edu.illinois.cs.cogcomp.lbjava.classify.Feature valueOf(int[] a0, double[] a1, @SuppressWarnings("rawtypes") java.util.Collection a2)
  {
    if (isClone)
    {
      loadInstance();
...
public edu.illinois.cs.cogcomp.lbjava.classify.ScoreSet scores(int[] a0, double[] a1, java.util.Collection a2)
  ...
  {
    public Parameters() { super((SparseNetworkLearner.Parameters) new RelationClassifier(false).getParameters()); }
  }
}
