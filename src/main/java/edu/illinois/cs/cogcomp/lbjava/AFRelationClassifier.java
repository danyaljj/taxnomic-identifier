...
public class AFRelationClassifier extends SparseNetworkLearner
{
  private static void loadInstance()
  {
    if (instance == null) instance = new AFRelationClassifier(true);
  }
  ...
  public static AFRelationClassifier instance;

  public static AFRelationClassifier getInstance()
  {
    loadInstance();
    return instance;
  }

  private AFRelationClassifier(boolean b)
  {
    ...
    name = "AFRelationClassifier";
    setEncoding(null);
    setLabeler(new Label());
    setExtractor(new AFRelationClassifier$$1());
    isClone = false;
  }
  ...
  public AFRelationClassifier()
  {
    super("edu.illinois.cs.cogcomp.lbjava.AFRelationClassifier");
    isClone = true;
  }

  public AFRelationClassifier(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

  public AFRelationClassifier(Parameters p, String modelPath, String lexiconPath) {
    super(p);
    try {
    ...
    else if (IOUtilities.existsInClasspath(AFRelationClassifier.class, modelPath)) {
      System.out.println("Model file "+modelfile.getAbsolutePath()+" located in a jar file");
      readModel(IOUtilities.loadFromClasspath(AFRelationClassifier.class, modelPath));
      readLexiconOnDemand(IOUtilities.loadFromClasspath(AFRelationClassifier.class, lexiconPath));
    }
    else {
      containingPackage = "edu.illinois.cs.cogcomp.lbjava";
      name = "AFRelationClassifier";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof Instance || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'AFRelationClassifier(Instance)' defined on line 37 of AFRelationClassifier.lbj received '" + type + "' as input.");
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: edu.illinois.cs.cogcomp.lbjava.AFRelationClassifier \\");
    ...
    AFRelationClassifier classifier = new AFRelationClassifier();
  ...
  public int hashCode() { return "AFRelationClassifier".hashCode(); }
  public boolean equals(Object o) { return o instanceof AFRelationClassifier; }
  ...
  {
    public Parameters() { super((SparseNetworkLearner.Parameters) new AFRelationClassifier(false).getParameters()); }
  }
}
