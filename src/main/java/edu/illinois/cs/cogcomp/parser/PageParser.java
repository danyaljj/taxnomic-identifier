...
//		output = output.replaceAll("\\(", "xZxZ");
//		output = output.replaceAll("\\)", "yZyZ");
//		output = output.replaceAll("[", "xWxW");
//		output = output.replaceAll("]", "yVyV");
//		output = output.replaceAll("\\|", "wZwZ");
//		output = output.replaceAll(":", "vZvZ");
//
