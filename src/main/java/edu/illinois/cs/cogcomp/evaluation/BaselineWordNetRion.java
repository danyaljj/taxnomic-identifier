...
public class BaselineWordNetRion {
	 ...
	 * 
	 */
	public BaselineWordNetRion(String inputFile) throws Exception {
	...
	public void evaluate(String outputResultFile, int task) throws Exception {
		...
		for (String line : arrLines) {
			...
			if (result.equals(relation)) {

				correct++;

				if (result.equals(SIBLING))
					correctCou++;
