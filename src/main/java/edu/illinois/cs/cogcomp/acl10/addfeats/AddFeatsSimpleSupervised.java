 ...
 * 
 */
package edu.illinois.cs.cogcomp.acl10.addfeats;
 ...
 */
public class AddFeatsSimpleSupervised {
	 ...
	 * 
	 */
	public AddFeatsSimpleSupervised() throws Exception {
	...
	public AddFeatsSimpleSupervised(String trainFile, String testFile)
			throws Exception {

		System.out.println("Reading training data...");
		arrTrainInstances = DataHandler.readTrainingInstancesAddFeats(
				trainFile, Constants.INPUT_TYPE_INTERMEDIATE);
		System.out.println("Training size: " + arrTrainInstances.size());

		System.out.println("Reading testing data...");
		arrTestInstances = DataHandler.readTestingInstancesAddFeats(testFile,
	...
	public static void main(String[] args) throws Exception {
		...
		AddFeatsSimpleSupervised lbj = new AddFeatsSimpleSupervised();
