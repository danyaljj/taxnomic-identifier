...
public class WordNetSnow {
	 ...
	 * 
	 */
	public WordNetSnow(String interFile) throws Exception {
	...
	public void classifierInWordNet(String max_level_up, String outputFile)
		...
		for (Instance ins : arrInstances) {
			...
			if (wnManager.getWord(POS.NOUN, ins.entity1) == null
					|| wnManager.getWord(POS.NOUN, ins.entity2) == null) {
				c++;
				continue;
			}
	...
	private boolean cousin(String entity1, String entity2) throws Exception {
		if (wnManager.getWord(POS.NOUN, entity1) == null) {
			if (wnManager.getWord(POS.NOUN, entity2) == null) {
				return false;
			} else {
				return false;
			}
